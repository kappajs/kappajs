...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"kappa.js":[function(require,module,exports) {
'use strict';
...
var Kappa = function Kappa(el) {
  _classCallCheck(this, Kappa);

  this.el = el;
  console.log('Kappa bootstrapped');
};

exports.default = Kappa;
function component(name, template, definition) {
  if (componentMap[name]) throw new Error('The component ' + name + ' is already registered');
  var component = new KappaComponent(definition, template);
  window.customElements.define(name, component);
  return component;
}

var KappaComponent = exports.KappaComponent = function (_CustomElement2) {
  _inherits(KappaComponent, _CustomElement2);

  function KappaComponent(definition, template) {
    _classCallCheck(this, KappaComponent);

    var _this = _possibleConstructorReturn(this, (KappaComponent.__proto__ || Object.getPrototypeOf(KappaComponent)).call(this));
...
var template = function template() {
  (0, _litHtml.html)(_templateObject);
};

(0, _kappa.component)('hello-world', template, {
  created: function created() {
    console.log('created');
  }
});
},{"./kappa":"kappa.js","lit-html":"node_modules/lit-html/lit-html.js"}],"index.js":[function(require,module,exports) {
'use strict';
...
var _kappa2 = _interopRequireDefault(_kappa);
...
exports.default = new _kappa2.default(el);
},{"./kappa":"kappa.js","./hello-world":"hello-world.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/webcomponents.04735dff.map